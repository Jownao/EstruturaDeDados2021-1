...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Recuperando primeiro elemento da fila: "+fila.Recuperar());
        
        //Alterando o dado do início da fila
        fila.Alterar(p6);
        System.out.println("Alterando primeiro elemento da fila pelo sexto: "+fila.Recuperar());
        
        //Removendo o dado do início da fila
        fila.Remover();
        System.out.println("Removendo primeiro elemento da fila: "+fila.Recuperar());
        System.out.println();
